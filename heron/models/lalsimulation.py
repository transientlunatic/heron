...
class LALSimulationApproximant(WaveformApproximant):
    ...
    def __init__(self):
        ...
        self.supported_converstions = {"mass_ratio", "total_mass", "luminosity_distance"}

        self.logger = logger = logging.getLogger("heron.models.LALSimulationApproximant")
        
    def _convert_units(self, args):

        units = {"mass": u.kilogram, "distance": u.meter, "frequency": u.Hertz, "time": u.second}
