...
%We present a method, using Gaussian processes, to
%determine the desirable locations in parameter space at which to place
%future simulations in the BBH parameter space, given a pre-existing
%catalogue of waveforms. We therefore intend to provide a principled
%method for deciding how to extend any pre-existing waveform catalogue.
