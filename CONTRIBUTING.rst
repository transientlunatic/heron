...
Report bugs at https://github.com/transientlunatic/heron/issues.
...
1. Fork the `heron` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/heron.git
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/transientlunatic/heron/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_heron
